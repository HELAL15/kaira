...
const SectionHeading = ({ title = 'Section Title' }: { title?: string }) => {
    ...
    return (
        <>
            <AnimateAOS>
                <section className='bg-background-secondary relative grid h-[100px] place-items-center p-0 md:h-[120px] lg:h-[150px] xl:h-[180px]'>
                    {/* <Image
                        fill
                        loading='eager'
                    ...
                    <div className='text-foreground relative z-10 container flex items-center justify-center gap-4'>
